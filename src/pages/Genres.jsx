    ...
    return (
        <Layout>
            <div className="page-header-top">
                <div>
                    <h1>Genres</h1>
                    <p className="subtitle">Manage book genres (Admin Only)</p>
                </div>
                ...
                {filteredGenres.map((genre) => (
                    <div key={genre.id} className="genre-card">
                        ...
                        <div style={{display:'flex', gap:'6px'}}>
                            <button className="icon-btn" onClick={() => setEditGenre(genre)} title="Edit">✏</button>
                            <button className="icon-btn" onClick={() => handleDeleteGenre(genre.id)} title="Delete">🗑</button>
                        </div>
                    </div>
                ))}
            </div>
