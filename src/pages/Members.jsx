...
function Members() {
    ...
    const handleAddMember = async () => {
        try {
            ...
            fetchMembers();
        } catch (error) { console.log('Failed to add member', error.response?.data); }
    };
    ...
    const handleEditMember = async () => {
        try {
            ...
            setEditMember(null);
            fetchMembers();
        } catch (error) { console.log('Failed to edit member', error.response?.data); }
    };
    ...
    const handleDeleteMember = async (id) => {
        try {
            ...
            fetchMembers();
        } catch (error) { console.log('Failed to delete member', error); }
    };
                    ...
                    {filteredMembers.map((member) => (
                        <div key={member.id} className="member-card">
                            ...
                            <div className="card-actions">
                                <button className="icon-btn history" onClick={() => handleViewHistory(member.id, member.name)} title="History">📋</button>
                                <button className="icon-btn edit" onClick={() => setEditMember(member)} title="Edit">✏</button>
                                <button className="icon-btn delete" onClick={() => handleDeleteMember(member.id)} title="Delete">🗑</button>
                            </div>
                        </div>
                    ))}
                </div>
