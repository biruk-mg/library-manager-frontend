                    ...
                    {filteredBooks.map((book) => (
                        <div key={book.id} className="book-card">
                            <div className="book-card-header">
                                <h3>{book.title}</h3>
                                <span className={`badge ${book.available_copies > 0 ? 'available' : 'unavailable'}`}>
                            ...
                            <div className="card-actions">
                                <button className="icon-btn edit" onClick={() => setEditBook(book)} title="Edit">✏</button>
                                <button className="icon-btn delete" onClick={() => handleDeleteBook(book.id)} title="Delete">🗑</button>
                            </div>
                        </div>
                    ))}
                </div>
